...
import { PracticumExperience } from "@/components/naira-section/practicum-experience";
import AboutMe from "@/components/naira-section/about-me";

export default function NairaSalima() {
    ...
    <>
      ...
      <div id="home" className="relative flex flex-col h-screen">
        ...
        <div className="absolute inset-0 flex items-center z-10">
          <Image alt="Me" src={`/naira.png`} quality={100} fill loading="lazy" className=""
            style={{
              objectFit: 'cover',
            }}
          />
              ...
              <div className="relative z-30 rounded-2xl m-4 p-8 md:p-14 bg-gradient-to-br from-dark-2 to-dark border-dark border-2 shadow-lg">
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="hidden xl:flex w-16 outline outline-1 outline-white" />
                    <h1 className="text-primary-50 font-bold text-xs md:text-xl text-start md:text-end font-secondary w-fit">Analytical Chemistry</h1>
                  </div>
                  <div className="z-10 flex flex-col xl:flex-row items-start xl:items-center mt-4 gap-2">
                    <ShimmerButton shimmerColor="#f0fdf1" background="linear-gradient(90deg, rgba(22,81,30,1) 0%, rgba(39,192,56,1) 100%)" className="shadow-2xl">
                      <span className="whitespace-pre-wrap text-center text-xs font-medium leading-none tracking-tight text-primary-50 dark:from-white dark:to-slate-900/10 lg:text-lg">
                        Hire Me!
                      </span>
                    </ShimmerButton>
                  ...
                  <div className="flex gap-1 md:gap-3 mt-1 md:mt-2">
                    <Link href="https://instagram.com/nayzho_ken" target="_blank" rel="noopener noreferrer">
                      <InstagramIcon color="white" width={iconSize} />
                    </Link>
                    <Link href="https://linkedin.com/in/nairasalima" target="_blank" rel="noopener noreferrer">
                      <LinkedinIcon color="white" width={iconSize} />
                    </Link>
                    <CopyButton text="nairasalima07@gmail.com" color="white" width={iconSize} />
                  </div>
                </div>
              </div>
            </div>
